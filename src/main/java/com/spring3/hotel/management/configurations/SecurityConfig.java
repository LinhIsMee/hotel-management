    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/bookings/", "/api/v1/bookings/{id}").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/bookings/user/{userId}").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/bookings/status/{status}").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/bookings/date-range").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/bookings/booked-rooms").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/bookings/create").hasAuthority("ROLE_USER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/bookings/cancel/{id}").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/bookings/confirm/{id}").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/bookings/update/{id}").authenticated()
